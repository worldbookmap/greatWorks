    ...
    <div className="flex flex-1 items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center gap-3">
          <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-accent to-accent-strong shadow-[0_0_32px_-6px_rgba(255,107,74,0.5)]">
        ...
        <form
          ...
          className="space-y-4 rounded-2xl border border-black/[0.07] bg-surface p-6 shadow-2xl shadow-black/[0.06]"
        >
          <div className="relative">
            <Lock className="pointer-events-none absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-[#a39a8d]" strokeWidth={2} />
            <input
              type="password"
              value={password}
